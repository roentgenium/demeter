...
# of the sidebar.
html_logo = '../_images/pallas_athene_thumb.png'
...
latex_documents = [
  ('index', 'Athena.tex', u'Athena Documentation',
...
man_pages = [
    ('index', 'athena', u'Athena Documentation',
     [u'Bruce Ravel'], 1)
]
...
texinfo_documents = [
  ('index', 'Athena', u'Athena Documentation',
   u'Bruce Ravel', 'Athena', 'One line description of project.',
   'Miscellaneous'),
]
