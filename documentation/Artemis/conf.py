...
# of the sidebar.
html_logo = '../_images/Artemis_logo.jpg'

# The name of an image file (within the static path) to use as favicon of the
# docs.  This file should be a Windows icon file (.ico) being 16x16 or 32x32
# pixels large.
html_favicon = '../_images/wheat.ico'
...
latex_documents = [
  ('index', 'Artemis.tex', u'Artemis Documentation',
...
man_pages = [
    ('index', 'athena', u'Artemis Documentation',
     [u'Bruce Ravel'], 1)
]
...
texinfo_documents = [
  ('index', 'Artemis', u'Artemis Documentation',
   u'Bruce Ravel', 'Artemis', 'One line description of project.',
   'Miscellaneous'),
]
